...
function TaskCart() {
    return (
        <div className='w-[349px] bg-blue-700 rounded-xl p-6 text-white flex items-center flex-col w-full h-[500px] gap-6 mt-12'>
            <div>
            ...
            <ul className='flex justify-center flex-col gap-4 w-full px-1 overflow-y-scroll	'>
                <li className='bg-blue-300 text-blue-950 p-3 font-bold w-full rounded-lg flex justify-between items-center'><span>Abc</span> 
                <div>
